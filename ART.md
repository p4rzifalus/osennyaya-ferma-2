...
|---|---|---|---|
| `mole.png` | 32×32 | 640×128 (20 колонок × 4 строки) | см. ниже |
| `plants.png` | 32×40 | 128×200 (4 × 5) | колонки — стадии: 0 семечко, 1 росток, 2 куст, 3 спелое; строки — морковь, редис, тыква, подсолнух, гриб |
| `held.png` | 16×16 | 80×16 (5 × 1) | урожай в лапах: морковь, редис, тыква, подсолнух, гриб |
| `decor.png` | 16×24 | 128×24 (8 × 1) | колонки 0–2 пучки травы, 3–5 цветы, 6–7 высокая трава |

**Крот (`mole.png`)** — колонки:
- 0–3 — стоит (дыхание, 3 кадра в секунду);
- 4–9 — идёт (10 кадров в секунду);
- 10–13 — действует: сажает, поливает, собирает;
- 14–19 — несёт урожай (лапы перед собой; урожай рисуется отдельно из `held.png`).
